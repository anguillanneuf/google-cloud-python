...
latex_documents = [
    ("index", "google-cloud.tex", u"google-cloud Documentation", author, "manual")
]
...
man_pages = [("index", "google-cloud", u"google-cloud Documentation", [author], 1)]
